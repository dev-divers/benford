...
})({"5yVEj":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "9b83cb14d0396ea9";
"use strict";
...
},{}],"4a3H1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
var _statisticalTestsJs = require("../benfordTools/statisticalTests.js");
const myBenfordObject = (0, _statisticalTestsJs.benfordObject)((0, _statisticalTestsJs.benfordFrequencies)());
...
(async function() {
    ...
    new (0, _autoDefault.default)(document.getElementById("benfordCharts"), {
        type: "bar",
        options: {
            animation: false,
            plugins: {
...
},{}],"c7abn":[function(require,module,exports) {
/****************************************************************
Number of times a particular digit (from 1 to 9) appears as the first digit in the given numbers

****************************************************************/ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "observedFrequencies", ()=>observedFrequencies);
/****************************************************************
Array of theoretical frequencies according to Benford's law

****************************************************************/ parcelHelpers.export(exports, "benfordFrequencies", ()=>benfordFrequencies);
parcelHelpers.export(exports, "benfordObject", ()=>benfordObject);
function observedFrequencies(numbers) {
    ...
    for (let number of numbers){
        ...
        if (firstDigit >= 1 && firstDigit <= 9) // Increment with ++ 
        freqs[firstDigit - 1]++;
    }
    return freqs;
}
function benfordFrequencies() {
    let freqs = [];
    for(let i = 1; i <= 9; i++)// Benford's law if occurs if the leading digit d (d ∈ {1, ..., 9}) occurs with probability[10] : 
    freqs.push(Math.log10(1 + 1 / i));
    return freqs;
}
const benfordObject = (probabilitiesArray)=>{
    const result = {};
    for(let i = 0; i < probabilitiesArray.length; i++)// A new key-value pair is created in the result object 
...
****************************************************************/ function calculateDeviations(observedFrequencies, benfordFrequencies) {
    const deviations = [];
    for(let i = 0; i < observedFrequencies.length; i++)deviations.push(observedFrequencies[i] - benfordFrequencies[i]);
    return deviations;
}
// Standard deviation
...
function chiTest(numbers, alpha) {
    ...
    if (testStat <= critValue) console.log("The sample follows Benford's law");
    else console.log("The sample does not follow Benford's law");
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5yVEj","4a3H1"], "4a3H1", "parcelRequire6bfa")

//# sourceMappingURL=index.d0396ea9.js.map
